...
write.csv(df, file.path("/home/lima/Project/simulation/Comparision/high", "KallistoReadCounts.csv"))
...
while(cutOff <= 10) {
  ...
  print(outPutName)
  outPutPath = file.path("/home/lima/Project/simulation/Comparision/high", outPutName)
